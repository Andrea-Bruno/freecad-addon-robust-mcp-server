...
with `just install::mcp-bridge-workbench` or by extracting the release
...
1. Install the Robust MCP Bridge workbench (`just install::mcp-bridge-workbench`, or extract the release archive into `Mod/RobustMCPBridge/`)
